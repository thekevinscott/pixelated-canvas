...
},{"color-string":"../node_modules/color-string/index.js","color-convert":"../node_modules/color-convert/index.js"}],"../src/index.ts":[function(require,module,exports) {
"use strict";
...
var makeElement = function makeElement(type, opts) {
  if (type === void 0) {
    type = 'div';
  }
...
function () {
  ...
  function Canvas(props) {
    ...
    this.onMouseDown = function (callback) {
      return _this.callbacks.onMouseDown = callback;
    };

    this.onMouseUp = function (callback) {
      return _this.callbacks.onMouseUp = callback;
    };

    this.onMouseMove = function (callback) {
      return _this.callbacks.onMouseMove = callback;
    };

    this.getCanvasData = function () {
      return _this.ctx.getImageData(0, 0, _this.canvas.width, _this.canvas.height);
    };

    this.drawPixel = function (_a, color) {
      var x = _a.x,
          y = _a.y;
    ...
    this.updateCanvasData = function (data) {
      return _this.ctx.putImageData(data, 0, 0, 0, 0, _this.canvas.width, _this.canvas.height);
    };
    ...
    this._onMouseDown = function (e) {
      _this.mouseIsDown = true; // this.lastE = e;

      _this.drawPixel(_this.getPosition(e));

      if (_this.callbacks.onMouseDown) {
        _this.callbacks.onMouseDown(e);
      }
    };
    ...
    this._onMouseUp = function (e) {
      ...
      if (_this.callbacks.onMouseUp) {
        _this.callbacks.onMouseUp(e);
      }
    };
    ...
    this._onMouseMove = function (e) {
      if (_this.ctx && _this.mouseIsDown) {
        ...
        if (_this.callbacks.onMouseMove) {
          _this.callbacks.onMouseMove(e);
        }
      }
    };
...
},{"color":"../node_modules/color/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
document.getElementById('pixel').onmousedown = function () {
  return moving = true;
};

document.getElementById('pixel').onmouseup = function () {
  return moving = false;
};

document.getElementById('pixel').onmousemove = function (e) {
  if (!moving) {
    return;
  }
...
document.getElementById('pixel').onclick = function (e) {
  return canvas.setPixelSize(e.target.value);
};
...
//# sourceMappingURL=/pixelated-canvas/example.e31bb0bc.map